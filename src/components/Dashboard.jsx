            ...
            <div className="lg:grid-cols-2">
                <div className="border outline-2 m-2 p-2">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 gap-4 justify-center">
                        <div className="p-4 bg-[#F6F7FF] border outline-2 rounded-lg font-semibold flex justify-center items-center">Profile Views <span className="text-[#4F65F6] text-3xl font-medium ml-2">{userData.dashboard_stats.profile_views}</span></div>
